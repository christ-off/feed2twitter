...
const ENTRY = {
  ...
  "id": ["http://localhost:4000/H%C3%A9r%C3%A9sie%20min%C3%A9rale%20St%C3%A9phane%20Desienne"],
  "content": [
    {
...
describe('Test information extraction from entry', () => {
  ...
  test('Should extract expected title', () => {
    // GIVEN
    const EXPECTED_STATUS = 'Ancien avis de #Lecture : Hérésie minérale - Desienne, Stéphane #Nouvelle #ScienceFiction #Religion';
    // WHEN
